...
process.env.ENTRA_ID_OIDC_WELL_KNOWN_CONFIGURATION_URL =
  'http://entra-id.auth/.well-known/openid-configuration'
process.env.ENTRA_ID_CLIENT_ID = 'test-entra-client-id'
process.env.ENTRA_ID_CLIENT_SECRET = 'test-entra-secret'
process.env.ENTRA_ID_TENANT_ID = 'test-tenant-id'
