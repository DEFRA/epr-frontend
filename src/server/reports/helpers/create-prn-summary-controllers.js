 ...
 * }} options
 */
export function createPrnSummaryControllers({ guardFn, getBackUrl, nextPage }) {
  /** @type {PageFieldsBuilder} */
  const pageFields = (ctx) => {
    const { material, periodLabel, periodShort, registration, reportDetail } =
      ctx
