...
const asMockRequest = (/** @type {object} */ value) =>
  asHapiRequest(
    /** @type {import('@hapi/hapi').Request} */ (/** @type {unknown} */ (value))
  )
...
describe('#authCallbackController', () => {
  ...
  describe('when user is authenticated', () => {
    ...
    it('should log sign-in with userId for unique user logging', async () => {
      ...
      await controller.handler(asMockRequest(mockRequest), asMockH(mockH))
  ...
  describe('error handling', () => {
    it('should throw Boom error when fetching organisations fails', async () => {
      ...
      await expect(
        controller.handler(asMockRequest(mockRequest), asMockH(mockH))
