 ...
 * every operator's copy of one step is a different address, and reporting those
 * would scatter a single funnel step across thousands of values. Hapi already
 * holds the pattern the address matched, which is the step itself. The same
 * address reaches the measurement library a second time as the next page's
 * referrer, which is what analyticsPageReferrer is for.
 *
