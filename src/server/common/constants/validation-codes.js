import { VALIDATION_CODE } from '#server/common/enums/validation.js'
...
const PERCENTAGE_ERROR_CODES = new Set([
  VALIDATION_CODE.MUST_BE_A_NUMBER,
  VALIDATION_CODE.MUST_BE_AT_LEAST_ZERO,
  VALIDATION_CODE.MUST_BE_LESS_THAN_1,
  VALIDATION_CODE.MUST_BE_AT_MOST_1
])
...
const WEIGHT_ERROR_CODES = new Set([
  ...
  VALIDATION_CODE.MUST_BE_AT_LEAST_ZERO,
  VALIDATION_CODE.MUST_BE_AT_MOST_1000
])
...
const DATE_ERROR_CODES = new Set([VALIDATION_CODE.MUST_BE_A_VALID_DATE])
...
const YES_NO_ERROR_CODES = new Set([
  VALIDATION_CODE.MUST_BE_YES_OR_NO,
  VALIDATION_CODE.MUST_BE_A_STRING
])
...
const DROPDOWN_ERROR_CODES = new Set([
  ...
  VALIDATION_CODE.MUST_BE_VALID_EWC_CODE,
  VALIDATION_CODE.MUST_BE_VALID_BASEL_CODE,
...
const ID_ERROR_CODES = new Set([VALIDATION_CODE.MUST_BE_3_DIGIT_ID])
...
const GROUP_DISPLAY_CODES = new Map([
  [VALIDATION_CODE.FILE_DOWNLOAD_FAILED, TECHNICAL_ERROR_DISPLAY_CODE],
  [VALIDATION_CODE.FILE_REJECTED, TECHNICAL_ERROR_DISPLAY_CODE],
  [VALIDATION_CODE.FILE_UPLOAD_FAILED, TECHNICAL_ERROR_DISPLAY_CODE],
  [VALIDATION_CODE.VALIDATION_SYSTEM_ERROR, TECHNICAL_ERROR_DISPLAY_CODE],
  [VALIDATION_CODE.VALIDATION_FALLBACK_ERROR, TECHNICAL_ERROR_DISPLAY_CODE],
  ['UNKNOWN', TECHNICAL_ERROR_DISPLAY_CODE],

  [VALIDATION_CODE.FIELD_REQUIRED, 'DATA_ENTRY_INVALID'],
  [VALIDATION_CODE.INVALID_TYPE, 'DATA_ENTRY_INVALID'],
  [VALIDATION_CODE.VALUE_OUT_OF_RANGE, 'DATA_ENTRY_INVALID'],
  [VALIDATION_CODE.INVALID_FORMAT, 'DATA_ENTRY_INVALID'],
  [VALIDATION_CODE.INVALID_DATE, 'DATA_ENTRY_INVALID'],
  [VALIDATION_CODE.CALCULATED_VALUE_MISMATCH, 'DATA_ENTRY_INVALID'],
  ...
  [
    VALIDATION_CODE.NET_WEIGHT_CALCULATION_MISMATCH,
    'CALCULATED_FIELD_MISMATCH'
  ],
  [VALIDATION_CODE.TONNAGE_CALCULATION_MISMATCH, 'CALCULATED_FIELD_MISMATCH'],
  [
    VALIDATION_CODE.UK_PACKAGING_PROPORTION_CALCULATION_MISMATCH,
    'CALCULATED_FIELD_MISMATCH'
  ],
  [VALIDATION_CODE.MUST_BE_A_NUMBER, 'DATA_ENTRY_INVALID'],
  [VALIDATION_CODE.MUST_BE_A_STRING, 'DATA_ENTRY_INVALID'],
  [VALIDATION_CODE.MUST_BE_A_VALID_DATE, 'DATA_ENTRY_INVALID'],
  [VALIDATION_CODE.MUST_BE_GREATER_THAN_ZERO, 'DATA_ENTRY_INVALID'],
  [VALIDATION_CODE.MUST_BE_AT_LEAST_ZERO, 'DATA_ENTRY_INVALID'],
  [VALIDATION_CODE.MUST_BE_LESS_THAN_1, 'DATA_ENTRY_INVALID'],
  [VALIDATION_CODE.MUST_BE_AT_MOST_1, 'DATA_ENTRY_INVALID'],
  [VALIDATION_CODE.MUST_BE_AT_MOST_1000, 'DATA_ENTRY_INVALID'],
  [VALIDATION_CODE.MUST_BE_AT_MOST_100_CHARS, 'DATA_ENTRY_INVALID'],
  [VALIDATION_CODE.MUST_BE_YES_OR_NO, 'DATA_ENTRY_INVALID'],
  [
    VALIDATION_CODE.MUST_CONTAIN_ONLY_PERMITTED_CHARACTERS,
    'DATA_ENTRY_INVALID'
  ],
  [VALIDATION_CODE.MUST_BE_3_DIGIT_ID, 'DATA_ENTRY_INVALID'],
  [VALIDATION_CODE.MUST_BE_VALID_EWC_CODE, 'DATA_ENTRY_INVALID'],
  [
    VALIDATION_CODE.MUST_BE_VALID_RECYCLABLE_PROPORTION_METHOD,
    'DATA_ENTRY_INVALID'
  ],
  [VALIDATION_CODE.MUST_BE_VALID_WASTE_DESCRIPTION, 'DATA_ENTRY_INVALID'],
  [VALIDATION_CODE.MUST_BE_VALID_BASEL_CODE, 'DATA_ENTRY_INVALID'],
  [VALIDATION_CODE.MUST_BE_VALID_EXPORT_CONTROL, 'DATA_ENTRY_INVALID'],

  [VALIDATION_CODE.MATERIAL_REQUIRED, 'MATERIAL_INVALID'],
  [VALIDATION_CODE.MATERIAL_MISMATCH, 'MATERIAL_INVALID'],
  [VALIDATION_CODE.MATERIAL_DATA_INVALID, 'MATERIAL_INVALID'],

  [VALIDATION_CODE.REGISTRATION_REQUIRED, 'REGISTRATION_INVALID'],
  [VALIDATION_CODE.REGISTRATION_MISMATCH, 'REGISTRATION_INVALID'],
  [VALIDATION_CODE.REGISTRATION_DATA_INVALID, 'REGISTRATION_INVALID'],

  [VALIDATION_CODE.ACCREDITATION_MISSING, 'ACCREDITATION_INVALID'],
  [VALIDATION_CODE.ACCREDITATION_MISMATCH, 'ACCREDITATION_INVALID'],
  [VALIDATION_CODE.ACCREDITATION_UNEXPECTED, 'ACCREDITATION_INVALID'],

  [VALIDATION_CODE.HEADER_REQUIRED, 'STRUCTURE_INVALID'],
  [VALIDATION_CODE.TABLE_UNRECOGNISED, 'STRUCTURE_INVALID'],

  [VALIDATION_CODE.PROCESSING_TYPE_INVALID, 'TEMPLATE_INVALID'],
  [VALIDATION_CODE.PROCESSING_TYPE_MISMATCH, 'TEMPLATE_INVALID'],
  [VALIDATION_CODE.PROCESSING_TYPE_REQUIRED, 'TEMPLATE_INVALID'],

  [VALIDATION_CODE.SPREADSHEET_INVALID_ERROR, 'TEMPLATE_INVALID'],
  [VALIDATION_CODE.SPREADSHEET_MALFORMED_MARKERS, 'TEMPLATE_INVALID']
])
