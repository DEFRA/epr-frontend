...
describe('#organisationController', () => {
  ...
  describe('happy Path', () => {
    ...
    it('should fall back to companyDetails.name when tradingName is absent', async ({
      server
    }) => {
      const fixtureWithoutTradingName = {
        ...fixtureData,
        companyDetails: {
      ...
      vi.mocked(
        fetchOrganisationModule.fetchOrganisationById
      ).mockResolvedValue(asOrganisation(fixtureWithoutTradingName))
    ...
    it('should fall back to companyDetails.name when tradingName is whitespace', async ({
      ...
      vi.mocked(
        fetchOrganisationModule.fetchOrganisationById
      ).mockResolvedValue(asOrganisation(fixtureWithWhitespaceTradingName))
    ...
    it('should display organisation page with exporting sites on exporting route', async ({
      ...
      vi.mocked(
        fetchOrganisationModule.fetchOrganisationById
      ).mockResolvedValue(asOrganisation(fixtureExportingOnly))
    ...
    it('should switch between tabs correctly using URL navigation', async ({
      ...
      const $reprocessing = load(reprocessingResponse.payload)
      ...
      const $exporting = load(exportingResponse.payload)
    ...
    it('should display materials with correct capitalization', async ({
      ...
      vi.mocked(
        fetchOrganisationModule.fetchOrganisationById
      ).mockResolvedValue(asOrganisation(fixtureSingleReprocessing))
    ...
    describe('registered-only', () => {
      ...
      it('should show registered-only', async ({ server }) => {
        vi.mocked(
          fetchOrganisationModule.fetchOrganisationById
        ).mockResolvedValue(asOrganisation(registeredOnlyOrganisation))
    ...
    describe('waste balance', () => {
      it('should not fetch waste balances when no displayable registrations', async ({
        ...
        vi.mocked(
          fetchOrganisationModule.fetchOrganisationById
        ).mockResolvedValue(asOrganisation(fixtureEmpty))
  ...
  describe('edge Cases', () => {
    it('should display "No sites found" when organisation has no accreditations', async ({
      ...
      expect(payload).toContain('No sites found.')
    })
    ...
    it('should display "No sites found" when all items have excluded statuses', async ({
      ...
      vi.mocked(
        fetchOrganisationModule.fetchOrganisationById
      ).mockResolvedValue(asOrganisation(fixtureAllExcluded))
    ...
    it('should filter out items with "Created" status', async ({ server }) => {
      ...
      vi.mocked(
        fetchOrganisationModule.fetchOrganisationById
      ).mockResolvedValue(asOrganisation(dataWithCreatedStatus))
    ...
    it('should filter out items with "Rejected" status', async ({ server }) => {
      ...
      vi.mocked(
        fetchOrganisationModule.fetchOrganisationById
      ).mockResolvedValue(asOrganisation(dataWithRejectedStatus))
    ...
    it('should handle missing site address fields gracefully', async ({
      ...
      vi.mocked(
        fetchOrganisationModule.fetchOrganisationById
      ).mockResolvedValue(asOrganisation(fixtureMissingSiteAddress))
    ...
    it('should display only exporting sites when no reprocessing sites exist', async ({
      ...
      expect(reprocessingResponse.payload).not.toContain('Reprocessing')
    ...
    it('should hide items when EITHER registration or accreditation has excluded status', async ({
      ...
      vi.mocked(
        fetchOrganisationModule.fetchOrganisationById
      ).mockResolvedValue(asOrganisation(dataWithMixedStatuses))
  ...
  describe('coverage - Additional Paths', () => {
    ...
    it('should handle multiple accreditations for the same site', async ({
      ...
      vi.mocked(
        fetchOrganisationModule.fetchOrganisationById
      ).mockResolvedValue(asOrganisation(dataWithMultipleMaterialsSameSite))
    ...
    it('should handle different status color mappings correctly', async ({
      ...
      vi.mocked(
        fetchOrganisationModule.fetchOrganisationById
      ).mockResolvedValue(asOrganisation(dataWithVariousStatuses))
    ...
    it('should display grey tag for unknown status', async ({ server }) => {
      ...
      vi.mocked(
        fetchOrganisationModule.fetchOrganisationById
      ).mockResolvedValue(asOrganisation(dataWithUnknownStatus))
