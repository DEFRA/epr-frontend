 ...
 * @param {{ nation?: string }} [tab] the nation the figures are narrowed to,
 *   as the backend spells it in a path. Naming that nation for a reader is
 *   this page's job, so the name comes from the locale file, not the path.
