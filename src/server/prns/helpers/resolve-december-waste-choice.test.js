...
describe(resolveDecemberWasteControl, () => {
  ...
  describe('none mode', () => {
    ...
    it('shows no control when the accreditation type resolves to none', () => {
      const result = resolveDecemberWasteControl(
        { mode: 'none', windowOpen: true },
        localise,
        'PRNs'
      )
