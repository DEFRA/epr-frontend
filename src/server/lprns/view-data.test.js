...
const createMockRequest = () => ({
  t: vi.fn((key, params = {}) => {
    const translations = {
      ...
      'lprns:create:helpText': `${params.noteTypePlural} can only be issued to packaging waste producers and compliance schemes who have registered with regulators.`,
